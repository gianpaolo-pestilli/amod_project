import os
from benchmark_pesato import overall_pesato
...
def get_config_paths():
    ...
    config = {
        ...
        "CSV_path": os.path.join(base_dir, "dataset_pesato.csv")
    }
    return config
...
def main():
    ...
    try:
        overall_pesato(paths['PLI_path'], paths['PL_path'], paths['CSV_path'])
